	...
	public ProfessorEditDialog(Professor professor) {
		...
		ok.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ProfessorController.getInstance().editProfessor(MyProfessorTable.rowIndex,tfSurname.getText(), tfName.getText(), tfEmail.getText(), tfBirthDate.getText(), home, work, tfPhoneNumber.getText(), tfId.getText(), comboCalling.getSelectedItem().toString(), comboTitle.getSelectedItem().toString(), Integer.parseInt(tfExp.getText()));
